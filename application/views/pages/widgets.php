        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget">
            ...
            <div class="box-footer box-comments">
              ...
              <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="<?php echo base_url(); ?>dist/img/user4-128x128.jpg" alt="User Image">
            ...
            <div class="box-footer">
              <form action="#" method="post">
                <img class="img-responsive img-circle img-sm" src="<?php echo base_url(); ?>dist/img/user4-128x128.jpg" alt="Alt Text">
          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <div class="attachment-block clearfix">
                <img class="attachment-img" src="<?php echo base_url(); ?>dist/img/photo1.png" alt="Attachment Image">
            ...
            <div class="box-footer box-comments">
              ...
              <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="<?php echo base_url(); ?>dist/img/user5-128x128.jpg" alt="User Image">
